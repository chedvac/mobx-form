export default {
  url: { hebrew: "עליך להזין תחילת כתובת במבנה WWW או HTTP" },
  hebrew: {
  ...
  arabic: {
    ...
    email:
      "يجب إدخال عنوان البريد الإلكتروني القياسي في الأحرف اللاتينية وبدون مسافات، في شكل X@X.XX",
  ...
  english: {
    ...
    email:
      "Please enter a valid email address using Latin characters (a-z) and without spaces in the following format: X@X.XX. Example: abc@def.gh",
