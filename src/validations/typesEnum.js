...
export default{
    ...
    //     email: {name: 'email', regex: regex.email, message: messages.address.hebrew.email},
        houseNumber: { name: 'houseNumber', regex: regex.houseNumber, message: messages.address.hebrew.houseNumber}
    },
    // general: {
    // },
    language:{
    ...
    digits: {
        notZeroDigits: {name: 'notZeroDigits',  regex: regex.notZeroDigits, message: messages.digits.hebrew.notZeroDigits},
        startWithZero: { name: 'startWithZero',regex: regex.startWithZero, message: messages.digits.hebrew.startWithZero},
        startWithDigit: {name: 'startWithDigit', regex: regex.startWithDigit, message: messages.digits.hebrew.startWithDigit}
    }
