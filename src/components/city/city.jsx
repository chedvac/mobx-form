...
export default class City extends React.Component{
    ...
    loadCityList = flow(function * () {
        try{
            const response = yield request({url: 'http://formsdev.vcloud.gov.il/govservicelist/ListProvider/GetList', method: 'POST', data: qs.stringify({listName: 'City'})})
        ...
        render(){
            ...
            <div className="row">
                <div className="col-md-4">
                    <Select options={this.cityList} {...this.props} label={this.currentResources().selectLanguage} />                    
                </div>
