...
class MiniDrawer extends React.Component {
    ...
    handleDrawerOpen = () => {
        this.setState({ open: true, openedByAppBar: true });
    };
    handleDrawerClose = () => {
        this.setState({ open: false, openedByAppBar: false });
    };
                    ...
                    <Divider />
                    {
                        actionsList.map((action, index) =>
                            <ToolBarButton
                                ...
                                icon={index}
                                open={this.open}
                                onMouseOverEvent={this.handleDrawerOpenByFocus}
                                onMouseOutEvent={this.handleDrawerCloseByFocus}
                            />
                        )
                    }
                </Drawer>
